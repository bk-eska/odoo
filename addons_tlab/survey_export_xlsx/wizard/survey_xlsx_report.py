...
class SurveyXlsReport(models.TransientModel):
    """This is the wizard model, We can filter the xls reports using this
    model"""
    _name = 'survey.xlsx.reports'
    _description = 'Survey XLSX Report '

    partner_id = fields.Many2one('res.partner', string="Partner",
                                 help="Select for getting the reports of the "
                                      "user")
    ...
    def action_print_survey_xlsx_report(self):
        """Call from button, It will print the xlsx reports"""
        data_dict = {}
    ...
    def get_xlsx_report(self, dict_data, response):
        """This function will get the xlsx reports"""
        output = io.BytesIO()
