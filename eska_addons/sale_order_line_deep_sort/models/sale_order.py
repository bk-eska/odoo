...
from .res_company import SO_SORTING_CRITERIA, SO_SORTING_DIRECTION
...
class SaleOrder(models.Model):
    ...
    line_order = fields.Selection(
        ...
        default=lambda self: self.env.company.default_so_line_order,
    )
    line_direction = fields.Selection(
        selection=SO_SORTING_DIRECTION,
        string="Sort Direction",
        default=lambda self: self.env.company.default_so_line_direction,
    )
