						...
						<tbody>
							<tr valign="top">
								...
								<td width="40%" align="right">
									<div id="logo">
										<xsl:if test="$logo">
											<img alt="Logo" style="max-width:250px;max-height:150px;" src="data:image/jpg;base64,{$logo}"/>
										</xsl:if>
									</div>
								</td>
							</tr>
							<tr style="height:118px; " valign="top">
								...
								<td width="20%" align="center">
									<div id="qrcode" style="height:100px; width:100px;">
										<xsl:if test="$qrcode">
											<img alt="Karekod" style="max-width:100px;max-height:100px;" src="data:image/jpg;base64,{$qrcode}"/>
										</xsl:if>
									</div>
