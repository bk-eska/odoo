...
field_renames = [
    ('res.partner', 'res_partner', 'customer_currency_rate_type_id',
     'sale_currency_rate_type_id'),
    ('res.partner', 'res_partner', 'supplier_currency_rate_type_id',
     'purchase_currency_rate_type_id'),
]
