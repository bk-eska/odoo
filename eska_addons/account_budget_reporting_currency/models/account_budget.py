    ...
    def _compute_practical_amount(self):
        for line in self:
            ...
            if line.analytic_account_id.id:
                ...
                select = "SELECT SUM(report_currency_amount) from " + from_clause + " where " + where_clause
                ...
                from_clause, where_clause, where_clause_params = where_query.get_sql()
                select = "SELECT sum(report_currency_credit)-sum(report_currency_debit) from " + from_clause + " where " + where_clause
