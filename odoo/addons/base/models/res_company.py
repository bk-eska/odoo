...
class Company(models.Model):
    ...
    report_footer = fields.Html(string='Report Footer', translate=True, help="Footer text displayed at the bottom of all report.")
    company_details = fields.Html(string='Company Details', help="Header text displayed at the top of all report.")
