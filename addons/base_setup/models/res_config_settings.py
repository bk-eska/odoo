...
class ResConfigSettings(models.TransientModel):
    ...
    report_footer = fields.Html(related="company_id.report_footer", string='Custom Report Footer', help="Footer text displayed at the bottom of all report.", readonly=False)
