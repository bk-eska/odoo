...
class PurchaseOrder(models.Model):
    ...
    report_grids = fields.Boolean(string="Print Variant Grids", default=True, help="If set, the matrix of configurable products will be shown on the reports of this order.")
