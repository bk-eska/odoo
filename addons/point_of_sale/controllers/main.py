...
class PosController(PortalAccount):
    ...
    def print_sale_details(self, date_start=False, date_stop=False, **kw):
        r = request.env['reports.point_of_sale.report_saledetails']
        pdf, _ = request.env['ir.actions.reports'].with_context(date_start=date_start, date_stop=date_stop)._render_qweb_pdf('point_of_sale.sale_details_report', r)
