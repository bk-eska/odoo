...
class TestPrintingReportXmlAction(TransactionCase):
    def setUp(self):
        ...
        self.Model = self.env["printing.reports.xml.action"]
    ...
    def test_onchange_printer_tray_id_empty(self):
        action = self.env["printing.reports.xml.action"].new({"printer_tray_id": False})
    ...
    def test_onchange_printer_tray_id_not_empty(self):
        ...
        action = self.env["printing.reports.xml.action"].new(
