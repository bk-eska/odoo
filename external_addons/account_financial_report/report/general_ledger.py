...
class GeneralLedgerReport(models.AbstractModel):
    _name = "reports.account_financial_report.general_ledger"
    ...
    def _get_report_values(self, docids, data):
        ...
        return {
            "doc_ids": [wizard_id],
            "doc_model": "general.ledger.reports.wizard",
            "docs": self.env["general.ledger.reports.wizard"].browse(wizard_id),
            "foreign_currency": data["foreign_currency"],
