...
class AbstractReportXslx(models.AbstractModel):
    _name = "reports.account_financial_report.abstract_report_xlsx"
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        report_data = {
            "workbook": None,
            "sheet": None,  # main sheet which will contains reports
            "columns": None,  # columns of the reports
    ...
    def _write_report_title(self, title, report_data):
        """Write reports title on current line using all defined columns width.
        Columns are defined with `_get_report_columns` method.
        """
    ...
    def _generate_report_content(self, workbook, report, data, report_data):
        """
        Allow to fetch reports content to be displayed.
        """
    ...
    def _get_report_name(self, report, data=False):
        """
        Allow to define the reports name.
        Report name will be used as sheet name and as reports title.
    ...
    def _get_report_footer(self):
        """
        Allow to define the reports footer.
        :return: the reports footer
        """
        return False

    def _get_report_columns(self, report):
        """
        Allow to define the reports columns
        which will be used to generate reports.
        :return: the reports columns as dict
        :Example:
        {
    ...
    def _get_report_filters(self, report):
        """
        :return: the reports filters as list
        :Example:
        [
