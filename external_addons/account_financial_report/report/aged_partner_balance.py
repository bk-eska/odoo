...
class AgedPartnerBalanceReport(models.AbstractModel):
    _name = "reports.account_financial_report.aged_partner_balance"
    ...
    def _get_report_values(self, docids, data):
        ...
        return {
            "doc_ids": [wizard_id],
            "doc_model": "open.items.reports.wizard",
            "docs": self.env["open.items.reports.wizard"].browse(wizard_id),
