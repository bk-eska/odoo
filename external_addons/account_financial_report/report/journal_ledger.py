...
class JournalLedgerReport(models.AbstractModel):
    _name = "reports.account_financial_report.journal_ledger"
    ...
    def _get_report_values(self, docids, data):
        ...
        wizard = self.env["journal.ledger.reports.wizard"].browse(wizard_id)
        ...
        return {
            "doc_ids": [wizard_id],
            "doc_model": "journal.ledger.reports.wizard",
            "docs": self.env["journal.ledger.reports.wizard"].browse(wizard_id),
