...
class TestVATReport(AccountTestInvoicingCommon):
    ...
    def _get_report_lines(self, taxgroups=False):
        ...
        if taxgroups:
            based_on = "taxgroups"
        vat_report = self.env["vat.reports.wizard"].create(
            {
        ...
        res_data = self.env[
            "reports.account_financial_report.vat_report"
    ...
    def test_01_compute(self):
        ...
        # Check reports based on taxtags
        ...
        # Check reports based on taxgroups
    ...
    def test_wizard_date_range(self):
        vat_wizard = self.env["vat.reports.wizard"]
