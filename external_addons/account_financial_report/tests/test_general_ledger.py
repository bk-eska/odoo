...
class TestGeneralLedgerReport(AccountTestInvoicingCommon):
    ...
    def _get_report_lines(self, with_partners=False, account_ids=False):
        ...
        general_ledger = self.env["general.ledger.reports.wizard"].create(
            {
        ...
        res_data = self.env[
            "reports.account_financial_report.general_ledger"
    ...
    def test_01_account_balance(self):
        ...
        # to check that it correctly used on reports
        self._add_move(
    ...
    def test_partner_filter(self):
        ...
        wizard = self.env["general.ledger.reports.wizard"].with_context(**context)
    ...
    def test_validate_date(self):
        ...
        wizard = self.env["general.ledger.reports.wizard"].with_context(user=user.id)
    ...
    def test_validate_date_range(self):
        ...
        wizard = self.env["general.ledger.reports.wizard"].create(
            {"date_range_id": dr.id}
        )
