...
class TestXmlReport(common.HttpCase):
    def test_xml(self):
        report_object = self.env["ir.actions.reports"]
    ...
    def test_xml_extension(self):
        ...
        # Test changing reports to use ".svg" extension
        ...
        # Test changing reports to use ".ffdata" extension
    ...
    def get_report_headers(self):
        return self.url_open(
            ...
            data={
                "data": json.dumps(
                    ["/reports/xml/report_xml.demo_report_xml_view/1", "qweb-xml"]
                ),
