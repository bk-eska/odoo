...
# License AGPL-3.0 or later (https://www.gnuorg/licenses/agpl.html).
{
    ...
    "assets": {
        "web.assets_backend": [
            "report_xml/static/src/js/reports/action_manager_report.esm.js",
        ],
    },
    "demo": [
        "demo/reports.xml",  # register reports in the system
        "demo/demo_report.xml",  # reports body definition
    ],
