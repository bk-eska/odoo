...
class TestMisBudget(TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        # create reports
        cls.report = cls.env["mis.reports"].create(dict(name="test reports"))
        cls.kpi1 = cls.env["mis.reports.kpi"].create(
            dict(
        ...
        cls.kpi2 = cls.env["mis.reports.kpi"].create(
            dict(
                report_id=cls.report.id,
                name="k2",
                description="kpi 2",
        ...
        # instance
        cls.instance = cls.env["mis.reports.instance"].create(
            dict(name="test instance", report_id=cls.report.id, comparison_mode=True)
        )
        cls.pact1 = cls.env["mis.reports.instance.period"].create(
            dict(
                name="pact1",
        ...
        cls.pbud1 = cls.env["mis.reports.instance.period"].create(
            dict(
                name="pbud1",
                report_instance_id=cls.instance.id,
        ...
        cls.pact2 = cls.env["mis.reports.instance.period"].create(
            dict(
                name="pact2",
                report_instance_id=cls.instance.id,
        ...
        cls.pbud2 = cls.env["mis.reports.instance.period"].create(
            dict(
                name="pbud2",
                report_instance_id=cls.instance.id,
                source=SRC_MIS_BUDGET,
    ...
    def test_name_search(self):
        ...
        expr = (
            self.env["mis.reports.kpi.expression"]
