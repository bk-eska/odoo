...
class TestAssetManagementXls(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.wiz_model = cls.env["wiz.account.asset.reports"]
        cls.company = cls.env.ref("base.main_company")
        # Ensure we have something to reports on
    ...
    def test_01_action_xls(self):
        """Check reports XLS action and generate reports"""
        ...
        model = self.env["reports.%s" % self.report_action["report_name"]].with_context(
