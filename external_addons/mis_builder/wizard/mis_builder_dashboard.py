...
class AddMisReportInstanceDashboard(models.TransientModel):
    _name = "add.mis.reports.instance.dashboard.wizard"
    ...
    def default_get(self, fields_list):
        ...
        if self.env.context.get("active_id", False):
            ...
            # get reports instance name
            res["name"] = (
                self.env["mis.reports.instance"]
    ...
    def action_add_to_dashboard(self):
        ...
        assert active_model == "mis.reports.instance"
        active_id = self.env.context.get("active_id")
        assert active_id
        # create the act_window corresponding to this reports
        ...
        report_result = (
            ...
            .create(
                {
                    "name": "mis.reports.instance.result.view.action.%d"
