...
class MisReportSubReport(models.Model):
    ...
    _sql_constraints = [
        (
            ...
            "Subreport name should be unique by reports",
        ),
        (
            "subreport_unique",
            "unique(subreport_id, report_id)",
            "Should not include the same reports more than once as sub reports "
            "of a given reports",
        ),
    ]
