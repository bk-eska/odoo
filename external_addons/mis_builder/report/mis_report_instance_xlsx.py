...
class MisBuilderXlsx(models.AbstractModel):
    _name = "reports.mis_builder.mis_report_instance_xlsx"
    _description = "MIS Builder XLSX reports"
    _inherit = "reports.report_xlsx.abstract"

    def generate_xlsx_report(self, workbook, data, objects):

        # get the computed result of the reports
        matrix = objects._compute_matrix()
        style_obj = self.env["mis.reports.style"]
